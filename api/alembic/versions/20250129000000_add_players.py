...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "player_key", postgresql.UUID(as_uuid=True), nullable=False, unique=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["owner_id"], ["users.id"], name="players_owner_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["current_post_id"], ["posts.id"], name="players_current_post_id_fkey"
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["players.id"],
            name="player_command_logs_player_id_fkey",
            ondelete="CASCADE",
        ),
    )

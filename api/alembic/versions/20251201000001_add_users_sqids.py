...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            server_default=text("nextval('users_new_id_seq')"),
        ),
    )
    ...
    op.execute(
        "SELECT setval('users_new_id_seq', COALESCE((SELECT MAX(new_id) FROM users), 0) + 1, false)"
    )
    ...
    op.add_column(
        "refresh_tokens", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.alter_column(
        "refresh_tokens", "user_id_new", new_column_name="user_id", nullable=False
    )

    # Auth identities table
    op.add_column(
        "auth_identities", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "auth_identities_user_id_fkey", "auth_identities", type_="foreignkey"
    )
    op.drop_column("auth_identities", "user_id")
    op.alter_column(
        "auth_identities", "user_id_new", new_column_name="user_id", nullable=False
    )
    ...
    op.add_column(
        "password_reset_tokens", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.alter_column(
        "comments", "author_id_new", new_column_name="author_id", nullable=True
    )
    ...
    op.alter_column(
        "playlists", "owner_id_new", new_column_name="owner_id", nullable=False
    )
    ...
    op.alter_column(
        "reactions", "user_id_new", new_column_name="user_id", nullable=True
    )
    ...
    op.alter_column(
        "follows", "follower_id_new", new_column_name="follower_id", nullable=False
    )
    op.alter_column(
        "follows", "following_id_new", new_column_name="following_id", nullable=False
    )

    # Category follows table - user_id
    op.add_column(
        "category_follows", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "uq_category_follow_user_category", "category_follows", type_="unique"
    )
    op.drop_constraint(
        "category_follows_user_id_fkey", "category_follows", type_="foreignkey"
    )
    op.drop_column("category_follows", "user_id")
    op.alter_column(
        "category_follows", "user_id_new", new_column_name="user_id", nullable=False
    )
    ...
    op.alter_column(
        "badge_grants", "user_id_new", new_column_name="user_id", nullable=False
    )

    # Reputation history table - user_id
    op.add_column(
        "reputation_history", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "reputation_history_user_id_fkey", "reputation_history", type_="foreignkey"
    )
    op.drop_column("reputation_history", "user_id")
    op.alter_column(
        "reputation_history", "user_id_new", new_column_name="user_id", nullable=False
    )
    ...
    op.alter_column(
        "reports", "reporter_id_new", new_column_name="reporter_id", nullable=False
    )

    # Admin notes table - created_by
    op.add_column(
        "admin_notes", sa.Column("created_by_new", sa.Integer(), nullable=True)
    )
    op.execute("""
        UPDATE admin_notes
    ...
    op.alter_column(
        "admin_notes", "created_by_new", new_column_name="created_by", nullable=False
    )
    ...
    op.alter_column(
        "players", "owner_id_new", new_column_name="owner_id", nullable=True
    )

    # Conformance checks table - user_id
    op.add_column(
        "conformance_checks", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "conformance_checks_user_id_key", "conformance_checks", type_="unique"
    )
    op.drop_constraint(
        "conformance_checks_user_id_fkey", "conformance_checks", type_="foreignkey"
    )
    op.drop_column("conformance_checks", "user_id")
    op.alter_column(
        "conformance_checks", "user_id_new", new_column_name="user_id", nullable=False
    )
    ...
    op.alter_column(
        "relay_jobs", "user_id_new", new_column_name="user_id", nullable=False
    )

    # GitHub installations table - user_id
    op.add_column(
        "github_installations", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "github_installations_user_id_fkey", "github_installations", type_="foreignkey"
    )
    op.drop_column("github_installations", "user_id")
    op.alter_column(
        "github_installations", "user_id_new", new_column_name="user_id", nullable=False
    )
    ...
    op.alter_column(
        "audit_logs", "actor_id_new", new_column_name="actor_id", nullable=False
    )
    ...
    op.alter_column(
        "blog_posts", "owner_id_new", new_column_name="owner_id", nullable=False
    )

    # Blog post comments table - author_id
    op.add_column(
        "blog_post_comments", sa.Column("author_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "blog_post_comments_author_id_fkey", "blog_post_comments", type_="foreignkey"
    )
    ...
    op.add_column(
        "blog_post_reactions", sa.Column("user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "blog_post_reactions_user_id_fkey", "blog_post_reactions", type_="foreignkey"
    )
    op.drop_column("blog_post_reactions", "user_id")
    op.alter_column(
        "blog_post_reactions", "user_id_new", new_column_name="user_id", nullable=True
    )

    # View events table - viewer_user_id (nullable)
    op.add_column(
        "view_events", sa.Column("viewer_user_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
        UPDATE view_events
    ...
    op.drop_constraint(
        "view_events_viewer_user_id_fkey", "view_events", type_="foreignkey"
    )
    op.drop_column("view_events", "viewer_user_id")
    op.alter_column(
        "view_events",
        "viewer_user_id_new",
        new_column_name="viewer_user_id",
        nullable=True,
    )
    ...
    op.alter_column(
        "site_events", "user_id_new", new_column_name="user_id", nullable=True
    )

    # Post view events table - viewer_id
    op.add_column(
        "post_view_events", sa.Column("viewer_id_new", sa.Integer(), nullable=True)
    )
    op.execute("""
    ...
    op.drop_constraint(
        "post_view_events_viewer_id_fkey", "post_view_events", type_="foreignkey"
    )
    op.drop_column("post_view_events", "viewer_id")
    op.alter_column(
        "post_view_events", "viewer_id_new", new_column_name="viewer_id", nullable=True
    )
    ...
    op.execute(
        "ALTER TABLE users ALTER COLUMN id SET DEFAULT nextval('users_new_id_seq')"
    )
    ...
    op.create_foreign_key(
        "reputation_history_user_id_fkey",
        "reputation_history",
        "users",
        ["user_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "conformance_checks_user_id_fkey",
        "conformance_checks",
        "users",
        ["user_id"],
        ["id"],
    ...
    op.create_unique_constraint(
        "conformance_checks_user_id_key", "conformance_checks", ["user_id"]
    )

    # Relay jobs table
    op.create_foreign_key(
        "relay_jobs_user_id_fkey",
        "relay_jobs",
        "users",
        ["user_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "blog_post_comments_author_id_fkey",
        "blog_post_comments",
        "users",
        ["author_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "blog_post_reactions_user_id_fkey",
        "blog_post_reactions",
        "users",
        ["user_id"],
        ["id"],
    ...
    # View events table
    op.create_foreign_key(
        "view_events_viewer_user_id_fkey",
        "view_events",
        "users",
        ["viewer_user_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "post_view_events_viewer_id_fkey",
        "post_view_events",
        "users",
        ["viewer_id"],
        ["id"],

"""Transport-agnostic player request/response payload schemas.

These were previously defined in ``app.mqtt.schemas``; they are now shared by
both the MQTT and HTTPS player backends. ``app.mqtt.schemas`` re-exports every
name here for backward compatibility.
"""

...
def get_artist_dashboard(
    ...
    **Query Parameters:**
    ...
    artist_stats_response = schemas.ArtistStatsResponse(
        ...
        total_impressions=artist_stats.total_impressions,
        views_by_country=artist_stats.views_by_country,
        views_by_device=artist_stats.views_by_device,
        daily_views=[schemas.DailyViewCount(**dv) for dv in artist_stats.daily_views],
        ...
        total_impressions_authenticated=artist_stats.total_impressions_authenticated,
        ...
        daily_views_authenticated=[
            schemas.DailyViewCount(**dv)
            for dv in artist_stats.daily_views_authenticated
        ],
    ...
    posts_response = [
        schemas.PostStatsListItem(
            ...
            total_impressions=ps.total_impressions,
            ...
            total_impressions_authenticated=ps.total_impressions_authenticated,

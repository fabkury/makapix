...
import { listPlayers, Player, sendCommandToAllPlayers } from '../../../lib/api';
...
export default function PlayersPage() {
  ...
  const handleSendToAll = async () => {
    ...
    try {
      // This will be called from the artwork page, but we can add a button here too
      // For now, this is a placeholder
      alert('Use the "Send to Player" button on artwork pages to send to all players');
    } catch (err: any) {

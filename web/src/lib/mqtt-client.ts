...
export interface SocialNotification {
  id: string;
  notification_type: "reaction" | "comment" | "comment_reply" | "comment_like" | "moderator_granted" | "moderator_revoked" | "follow" | "reputation_change" | "post_promoted" | "mod_hashtags_updated";
  post_id: number | null;

 ...
 * Both tabs are visible to every viewer (Favourites are public).
 */
...
export default function ProfileTabs({ activeTab, onTabChange, isAuthenticated: _isAuthenticated = false }: ProfileTabsProps) {
  return (

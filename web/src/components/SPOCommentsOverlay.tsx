    ...
    <>
      ...
      <style jsx>{`
        .spo-comments-backdrop {
          animation: spoCommentsBackdropIn 200ms ease-out;
        }
        .spo-comments-modal {
          animation: spoCommentsModalIn 200ms ease-out;
        }
        @keyframes spoCommentsBackdropIn {
          from { opacity: 0; }
          to { opacity: 1; }
        }
        @keyframes spoCommentsModalIn {
